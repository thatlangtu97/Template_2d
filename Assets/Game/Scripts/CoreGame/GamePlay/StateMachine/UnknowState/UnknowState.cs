...
{
    [CreateAssetMenu(fileName = "UnknowState", menuName = "CoreGame/State/UnknowState")]
    public class UnknowState : State
    {
        ...
        public override bool IsFinishDuration
        {
            get { return timeTrigger >= currentState.durationAnimation; }
        }
